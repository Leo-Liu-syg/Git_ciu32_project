...
/*-------------------------------------------define---------------------------------------------*/
#define SPEED_100K_TIMING       (0x00303D5B)
...
void i2c1_slave_init(void)
{
    ...
    /* 设置I2C1的外设时钟源为RCH */
    std_rcc_set_i2c1clk_source(RCC_I2C1_ASYNC_CLK_SRC_RCH);
    ...
    i2c1_init_config.digital_filter = I2C_DIGITALFILTER_DISABLE;
    ...
    /* 使能I2C的Stop模式唤醒功能 */
    std_i2c_wakeup_from_stop_enable(I2C1);
    
    /* 使能I2C的ADDRIE */
    std_i2c_interrupt_enable(I2C1, I2C_INTERRUPT_ADDR);
}
